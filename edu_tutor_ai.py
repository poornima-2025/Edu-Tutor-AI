...
Original file is located at
    https://colab.research.google.com/drive/1mPUFCawU4HzPbB3CrtMjFR2MocqT8Mde
"""
...
with gr.Blocks(title="Edu Tutor AI", theme=gr.themes.Soft()) as app:
    gr.Markdown("# 🎓 Edu Tutor AI - Your Personal Learning Assistant")
    ...
    with gr.Tab("📄 Study Material Summarizer"):
        with gr.Row():
            with gr.Column():
                study_pdf = gr.File(
    ...
    gr.Markdown("---")
    gr.Markdown("*💡 Tip: For best results, be specific about your topic or question. The AI tutor is here to help you learn!*")
